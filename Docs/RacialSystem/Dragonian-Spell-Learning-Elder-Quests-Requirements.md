...
**Related:** [Human — Class powers](Human-Class-Powers-Requirements.md) (Mage spell **learning** sources deferred — **different folk, Magic Power**), [Racial abilities menu](../UI/Racial-Abilities-Menu-Requirements.md) (future Dragonian spell sheet — learned vs memorized), [Tiefling — Fleshmetal Forgemaster](Tiefling-Fleshmetal-Forgemaster-NPC-Requirements.md) (multi-NPC extensibility pattern).
