...
{
    public sealed class EssencePickupConfirmDialogUI : MonoBehaviour
    {
        static EssencePickupConfirmDialogUI _instance;
        ...
        public static EssencePickupConfirmDialogUI EnsureInstance()
        {
            if (_instance != null)
                return _instance;

            var go = new GameObject(nameof(EssencePickupConfirmDialogUI));
            DontDestroyOnLoad(go);
            _instance = go.AddComponent<EssencePickupConfirmDialogUI>();
            return _instance;
        }
        ...
        public void Show(string body, Action onYes)
        {
            EnsureModalBuilt();
            _onYes = onYes;
            _blocking = true;
            ...
            if (_bodyText != null)
            {
                _bodyText.text = body + "\n\n<size=14><color=#9bbdff>Y</color> confirm   ·   "
                    + "<color=#ffb28a>N</color> cancel</size>";
            }
        ...
        void EnsureModalBuilt()
        {
            ...
            bubbleRt.sizeDelta = new Vector2(560f, 300f);
