...
namespace JRogue.UI.Racial
{
    static class RacialUiTheme
    {
        ...
        public static readonly Color HumanKnightSectionAccent = new Color(0.784f, 0.627f, 0.376f, 1f);
        public static readonly Color HumanKnightSecondaryAccent = new Color(0.91f, 0.72f, 0.28f, 1f);
        public static readonly Color HumanKnightBudgetBackground = new Color(0.14f, 0.12f, 0.1f, 0.95f);
        public static readonly Color HumanKnightColumnBackground = new Color(0.11f, 0.115f, 0.12f, 0.92f);
        ...
        static Sprite _humanKnightSkillEmblemSprite;
        ...
        public static Sprite HumanKnightSkillEmblemSprite
        {
            get
            {
                if (_humanKnightSkillEmblemSprite == null)
                    _humanKnightSkillEmblemSprite = CreateHumanKnightSkillEmblemSprite();

                return _humanKnightSkillEmblemSprite;
            }
        }
        ...
        static Sprite CreateHumanKnightSkillEmblemSprite()
        {
            const int size = 32;
            var tex = new Texture2D(size, size, TextureFormat.RGBA32, false);
            tex.filterMode = FilterMode.Bilinear;
            Vector2 center = new Vector2(size * 0.5f, size * 0.5f);
            Color ring = new Color(0.784f, 0.627f, 0.376f, 0.95f);
            Color core = new Color(0.91f, 0.72f, 0.28f, 0.9f);
